...
app.get("/", function (req, res) { 
    res.render("index");        // this view should be under ...scraping/views
});
...
app.get("/scrape", function (req, res) {
    ...
    axios.get("https://www.developer-tech.com/").then(function (response) {
        ...
        $("article h3").each(function (i, element) {
            ...
            // ----------------------------//
            // insert if not exists mongodb//
            // ----------------------------//
            // https://gist.github.com/ykst/d1a024f1d800311744be
            ...
            // db.Article.findAndModify({query: {i:0}, update: {$setOnInsert: {i: 0}}, upsert: true})

            db.Article.update(result, true, false)
